...
\begin{figure}[h]
\centering
\IfFileExists{figs/baron_loss.pdf}{\includegraphics[width=0.49\columnwidth]{figs/baron_loss.pdf}}{}\hfill
...
\begin{figure}[h]
\centering
\IfFileExists{figs/fig2_depth.pdf}{\includegraphics[width=\columnwidth]{figs/fig2_depth.pdf}}{}%
...
\paragraph{Corollary~1 (All three mechanisms best).} The joint (ERA) family contains embedding-only
($\Phi{=}0,\lambda_{\mathrm{attn}}{=}0$), router-only ($\lambda{=}0,\lambda_{\mathrm{attn}}{=}0$), and
attention-bias-only ($\lambda{=}0,\Phi{=}0$) as no-op restrictions, so
