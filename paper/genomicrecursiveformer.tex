...
\quad Oeso. & 56.7\,$\pm$\,3.4 & 56.6\,$\pm$\,3.5 & 58.9\,$\pm$\,2.9 & 69.6\,$\pm$\,1.4 & 57.5\,$\pm$\,3.6 & 56.8\,$\pm$\,3.1 \\
\quad Seger. & 56.5\,$\pm$\,7.6 & 56.0\,$\pm$\,7.7 & 0.1\,$\pm$\,0.0 & 71.4\,$\pm$\,5.3 & 0.1\,$\pm$\,0.0 & 53.8\,$\pm$\,10.7 \\
\quad Spleen & 48.9\,$\pm$\,3.0 & 49.7\,$\pm$\,3.7 & 57.9\,$\pm$\,1.7 & 58.2\,$\pm$\,0.9 & 49.1\,$\pm$\,3.7 & 49.4\,$\pm$\,0.0 \\
...
\midrule
\textbf{Mean} & \textbf{57.1} & \textbf{57.9} & \textbf{45.2} & \textbf{66.7} & \textbf{42.3} & \textbf{57.8} \\
$\Delta$ vs None & +0.0 & +0.8 & -11.9 & \textbf{+9.5} & -14.8 & +0.7 \\
\bottomrule
\end{tabular}}
...
\quad Baron & -- & -- & -- & 79.1\,$\pm$\,2.8 \\
\quad Lung & 74.8\,$\pm$\,0.2 & 76.1\,$\pm$\,0.1 & 68.9\,$\pm$\,0.6 & 79.1\,$\pm$\,1.2 \\
\quad Muraro & -- & -- & -- & 75.3\,$\pm$\,6.4 \\
\quad Oeso. & 69.5\,$\pm$\,1.1 & 70.6\,$\pm$\,0.7 & 66.3\,$\pm$\,0.9 & 69.6\,$\pm$\,1.4 \\
\quad Seger. & -- & -- & -- & 71.4\,$\pm$\,5.3 \\
\quad Spleen & 64.8\,$\pm$\,0.0 & 64.2\,$\pm$\,0.0 & 59.6\,$\pm$\,0.0 & 58.2\,$\pm$\,0.9 \\
\quad T-cell & -- & -- & -- & 68.9\,$\pm$\,1.0 \\
\quad Xin & -- & -- & -- & 64.7\,$\pm$\,9.4 \\
\midrule
\multicolumn{5}{l}{\emph{Multi-omics (Reactome/P-NET)}} \\
\quad Prostate & -- & -- & -- & 66.0\,$\pm$\,3.7 \\
\quad BLCA & -- & -- & -- & 49.2\,$\pm$\,4.3 \\
\quad STAD & -- & -- & -- & 52.0\,$\pm$\,5.8 \\
\midrule
\textbf{Mean} & \textbf{69.7} & \textbf{70.3} & \textbf{65.0} & \textbf{66.7} \\
\bottomrule
\end{tabular}}
