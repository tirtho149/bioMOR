...
3 seeds. The headline expert-choice shared-weight model is compared against
...
is exact and present \emph{before any training}: at $K{=}$4 the shared model
uses 4$\times$ fewer stack parameters, and the gap widens linearly with depth.
