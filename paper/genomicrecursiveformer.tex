...
\emph{warm-started} from the biological graph. Our controlled study spans 11
datasets ($8$ genomap single-cell suites and $3$ Reactome/P-NET multi-omics
...
70.8\% ($+11.7$ points over a no-prior router and well above
a degree-matched random graph, 57.5\%), the decisive routing result;
...
(42.4\% vs.\ 57.5\% on single cell) and collapses on several suites,
...
independent layers, a $4\times$ reduction at $K{=}4$, at comparable
accuracy) and \emph{token reduction} (a few dozen to a few hundred interpretable tokens
recover most full-gene accuracy), and adaptive depth buys a $\sim$38\%
...
it lifts single-cell macro-F1 to 70.8\% ($+11.7$ points over
...
$4\times$ reduction at $K{=}4$; Table~\ref{tab:param}),
...
($\sim$38\% fewer recursion FLOPs at matched accuracy;
Table~\ref{tab:ladder}).
\item We evaluate on all 11 datasets -- $8$ genomap single-cell suites
(Baron, Lung, Muraro, Oesophagus, Segerstolpe, Spleen, T-cell, Xin) and $3$
...
\quad Prostate & 67.2\,$\pm$\,0.4 & 54.1\,$\pm$\,1.2 & 64.6\,$\pm$\,2.1 & 66.0\,$\pm$\,3.7 \\
\quad BLCA & 45.5\,$\pm$\,3.4 & 50.4\,$\pm$\,0.7 & 51.4\,$\pm$\,4.0 & 49.2\,$\pm$\,4.3 \\
\quad STAD & 49.1\,$\pm$\,2.7 & 46.7\,$\pm$\,6.8 & 48.7\,$\pm$\,9.1 & 52.0\,$\pm$\,5.8 \\
\midrule
\textbf{Mean} & \textbf{74.8} & \textbf{71.7} & \textbf{69.8} & \textbf{66.7} \\
\bottomrule
\end{tabular}}
...
66.7\% ($+$9.8 points), and it is more accurate on nearly every dataset,
...
\quad Prostate & 54.5 & 66.0 & $+11.5$ \\
\quad BLCA & 40.0 & 49.2 & $+9.2$ \\
\quad STAD & 53.0 & 52.0 & $-1.1$ \\
\midrule
\textbf{Mean macro-F1} & \textbf{56.8} & \textbf{66.7} & \textbf{$+9.8$} \\
\midrule
