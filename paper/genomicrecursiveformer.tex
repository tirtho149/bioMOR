...
256 marker tokens out of 4,000 gene tokens, a 93.6\%
reduction that lowers self-attention cost by 244.1$\times$
($O(N^2)\!\to\!O(M^2)$), and the retained tokens are the informative ones: they carry
a mean marker-query importance of 34.13 versus 11.96 for the discarded
