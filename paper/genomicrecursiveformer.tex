...
\quad Spleen & 48.9\,$\pm$\,3.0 & 49.7\,$\pm$\,3.7 & 57.9\,$\pm$\,1.7 & 58.2\,$\pm$\,0.9 & 49.1\,$\pm$\,3.7 & 47.3\,$\pm$\,3.6 \\
...
$\Delta$ vs None & +0.0 & +0.8 & -11.9 & \textbf{+9.5} & -14.8 & +0.5 \\
\bottomrule
\end{tabular}}
...
independent layers, so at $K{=}$4 the shared model uses 4$\times$
