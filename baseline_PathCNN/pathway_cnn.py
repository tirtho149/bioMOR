...
def calculate_metrics(y_true, y_pred_proba, y_pred_binary):
    ...
    # Regular F1, Precision, Recall (macro-averaged for consistency with other models)
    metrics['f1'] = f1_score(y_true, y_pred_binary, average='macro')
    metrics['precision'] = precision_score(y_true, y_pred_binary, average='macro')
    metrics['recall'] = recall_score(y_true, y_pred_binary, average='macro')
