...
# pnet
# Allow override via PNET_PARAMS_FILE env var (e.g. "./pnet/crossvalidation_average_reg_10_tanh_blca").
_env_pf = os.environ.get("PNET_PARAMS_FILE")
if _env_pf:
    params_file_list.append(_env_pf)
else:
...
# params_file_list.append('./pnet/crossvalidation_average_reg_10_tanh_multiclass_kirc')
#
# # other ML models
...
for params_file in params_file_list:
    ...
    params = _load_module_from_path(params_file, params_file_full)
