...
# 17940 common genes). Writes to results_3mod/ so the 2-modal results in
...
export SURV_RESULTS_DIR=results_3mod
export SURV_DATASET_TAG=pan_survival_3mod
mkdir -p "$DIR/results_3mod"

echo "############## 3-MODAL SURVIVAL (CNV+mutation+expression) ##############"
...
echo ""; echo "############## ALL 3-MODAL SURVIVAL RUNS DONE ##############"
